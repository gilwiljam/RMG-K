...
enum class SettingsID
{
    ...
    // Kaillera Netplay Settings
    Kaillera_ActiveMode,
    Kaillera_Username,
    Kaillera_Port,
    Kaillera_FrameDelay,
    Kaillera_ConnectionSetting,
    Kaillera_RecordingEnabled,
    Kaillera_RecordsDirectory,
    Kaillera_RecordingCapEnabled,
    Kaillera_RecordingCapMB,
    Kaillera_SpoofPing,
    Kaillera_30fpsMode,
    Kaillera_MaxPlayers,
    Kaillera_MaxPing,
    Kaillera_FlashOnJoin,
    Kaillera_BeepOnJoin,
    ...
    Kaillera_ServerListCountries,
    Kaillera_ServerListPings,
    Kaillera_ServerListPingValues,
    Kaillera_LiveServerCacheNames,
    Kaillera_LiveServerCacheHosts,
    Kaillera_LiveServerCacheCountries,
    Kaillera_LiveServerCachePings,
    Kaillera_LiveServerCachePingValues,
    ...
    Input_ZTrigger2_InputType,
    Input_ZTrigger2_Name,
    Input_ZTrigger2_Data,
    Input_ZTrigger2_ExtraData,
